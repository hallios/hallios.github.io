/*!
Halli0s Web App by gary23w
Copyright (c) 2023 Halli0s
Licensed under the MIT License. See https://github.com/hallios for details.
 */
!(function (e, t) {
  "use strict";
    ...
    function se(t, e, n, r) {
      ...
      if (!r && (C(e), (e = e || T), E)) {
        if (11 !== f && (s = te.exec(t)))
          if ((u = s[1])) {
            if (9 === f) {
              if (!(i = e.getElementById(u))) return n;
            ...
            if (
              ...
              return P.apply(n, e.getElementsByClassName(u)), n;
          }
        if (
          d.qsa &&
          !I[t + " "] &&
          ...
          if (((u = t), (c = e), 1 === f && (Q.test(t) || X.test(t)))) {
            for (
          ...
          try {
            return P.apply(n, c.querySelectorAll(u)), n;
          } catch (e) {
            I(t, !0);
          } finally {
    ...
    function we(p, h, m, g, v, e) {
      return (
        ...
        ue(function (e, t, n, r) {
          ...
          } else (d = xe(d === t ? d.splice(u, d.length) : d)), v ? v(null, t, d, r) : P.apply(t, d);
        })
      );
    }
    function Ce(g, v) {
  ...
  (E.Callbacks = function (r) {
    ...
    r =
      "string" == typeof r
        ...
        : E.extend({}, r);
    function o() {
      for (a = a || r.once, t = i = !0; l.length; u = -1)
